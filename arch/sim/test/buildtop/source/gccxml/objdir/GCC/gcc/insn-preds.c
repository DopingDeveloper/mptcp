/* Generated automatically by the program './genpreds'
   from the machine description file '/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/i386.md'.  */
...
#line 24 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 29 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 34 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(ANY_FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 39 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 44 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 49 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 58 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 67 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
{
  return ((GET_CODE (op) == REG) && (
#line 81 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(REGNO (op) == 0))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 86 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 91 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (!TARGET_64BIT)
...
#line 218 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_DOUBLE:
...
{
  return (
#line 303 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 311 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 319 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 326 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 336 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return 0;
...
{
  return (
#line 356 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(!TARGET_64BIT || !flag_pic)) ? (nonmemory_operand (op, mode)) : ((register_operand (op, mode)) || ((const_double_operand (op, mode)) && (
#line 360 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(GET_MODE_SIZE (mode) <= 8))));
}

static inline int
symbolic_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 366 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 409 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  op = XEXP (op, 0);
  if (TARGET_64BIT)
    {
...
#line 438 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 471 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 475 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 480 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(XINT (op, 1) == UNSPEC_TP))) && (
(mode == VOIDmode || GET_MODE (op) == mode)));
}
...
#line 491 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 504 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 539 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 548 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(op == const1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 553 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}

static inline int
const248_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 558 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 566 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 571 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 576 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 581 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 586 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 591 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (op) >= 0 && INTVAL (op) <= 255));
}

static inline int
const_0_to_255_mul_8_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 596 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 605 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 610 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 615 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (op) >= 4 && INTVAL (op) <= 7));
}

static inline int
const_pow2_1_to_8_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 620 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 628 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  unsigned int log = exact_log2 (INTVAL (op));
  return log <= 7;
}
...
#line 636 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 648 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 652 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
{
  return (
#line 657 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 665 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 687 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 714 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 731 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 743 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 799 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 811 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
{
  return (memory_operand (op, mode)) && (
#line 828 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(memory_address_length (op) != 0));
}

static inline int
fcmov_comparison_operator_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 833 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
...
#line 875 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 910 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 967 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
#line 982 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
(INTVAL (XEXP (XEXP (op, 0), 1)) == 8)) && (
#line 983 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/predicates.md"
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 93 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 31);

    case CONSTRAINT_J:
      return 
#line 98 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 63);

    case CONSTRAINT_K:
      return 
#line 103 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= -128 && ival <= 127);

    case CONSTRAINT_L:
      return 
#line 108 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/constraints.md"
(ival == 0xFF || ival == 0xFFFF);

    case CONSTRAINT_M:
      return 
#line 113 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 3);

    case CONSTRAINT_N:
      return 
#line 119 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 255);

    case CONSTRAINT_O:
      return 
#line 124 "/home/dkoe/mptcp/arch/sim/test/buildtop/source/gccxml/GCC/gcc/config/i386/constraints.md"
(ival >= 0 && ival <= 127);
